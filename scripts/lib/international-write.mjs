...
export function buildIntlPrompt(story, recentActive = []) {
  ...
  return [
    ...
    '   - 台灣讀者視角的繁中，編輯部中性語氣，去 AI 腔（統一禁用清單見下）；**不要加入個人觀點/立場**。',
