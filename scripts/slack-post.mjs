...
// 頻道路由：❌/⚠️ 開頭的失敗哨兵一律 dev > 明確 channelId 參數 > 'authors'/'default'（強制作者群）> payload.category
...
import { channelForCategory, SLACK_CHANNEL, DEV_CHANNEL, isAlert } from './lib/report-config.mjs';
...
// ❌/⚠️ 開頭＝失敗哨兵，一律強制 dev（贏過 category 與明確 channelId，見 report-config.mjs）。
const channel =
  isAlert(text) ? DEV_CHANNEL
