...
status: "scheduled"
coverImage: "covers/anthropic-korea-in-region-data-playbook-cover.webp"
...
### 韓國企業為什麼敢把核心開發流程交給 Claude？
因為 Anthropic 把在地辦公室、資料主權、國家級安全合作、in-region data 四件事一起打包端上桌，少任何一件，採購單位的法務和資安都過不了關，模型再強也只能停在 PoC 階段。

### Hanwha Solutions 為什麼選擇用 AWS Bedrock 導入 Claude？
官方公告寫明是為了滿足嚴格的境內資料落地與安全要求，資料不出境是它願意把 Claude 給全球員工使用的前提條件。

### 首爾辦公室開幕同一週發生了什麼狀況？
美國商務部發布出口管制令，要求對外國人停止存取 Claude Fable 5 與 Mythos 5，連三星電子、SK 海力士、SK 電訊、KISA 等剛簽約的韓國夥伴合作都被卡住，顯示 in-region data 解決不了地緣政治斷供的風險。

### Anthropic 跟韓國政府有哪些合作？
Anthropic 與韓國科學技術資通訊部簽 MOU，跟韓國 AI 安全研究所合作評測 Claude 在韓語情境下的安全性，並把 Claude 給國家 AI 研究聯盟（涵蓋 KAIST、高麗、延世、POSTECH）的 60 名研究者做安全與對齊研究。

### 台廠導入前沿 AI 時該從韓國案例學到什麼？
要把 in-region 資料控管當成談判籌碼，並先盤點資料邊界、供應商可換性、與政府主權 AI 方向的對齊，順序是先定義情境再選工具，不能先簽約才煩惱資料流向。
