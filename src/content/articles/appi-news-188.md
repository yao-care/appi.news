...
readingTime: 12
expertNote: "三色標示是消費端工具，不是把關工具，選購時仍該優先看成分表長度與加工程度，而非只認燈號。對重視藥食同源的人來說，天然食材本就不需要標示背書，真正該留意的是加工食品業者是否選擇性標示，讓紅黃綠淪為行銷語言而非公共衛生工具。"
risksAndLimits:
...
![台灣食品紅黃綠標示制度：糖、鈉、飽和脂肪三色分級閾值說明圖](https://appi.news/images/appi-news-188/1.svg)
...
![食品前端標示到慢性病預防的路徑示意圖：標示影響消費決策、飲食型態、風險因子，最終降低慢性病發生率](https://appi.news/images/appi-news-188/2.png)
...
《黃帝內經·素問·臟氣法時論》有一段話：「五穀為養，五果為助，五畜為益，五菜為充，氣味合而服之，以補精益氣。」（6）這段話講的不只是食物分類本身，真正的重點在於**不同食物各有其「位置」**，過量就會失衡，搭配才能補益。
...
5. **不確定時回歸食物本身**：沒有標示的食材，例如蔬菜、豆類、全穀類、新鮮魚肉，根本不需要看標示。三色制度是為了輔助加工食品的選擇，不是取代對原型食物的信任。

![消費者在紅黃綠標示上路前的實用食品選購五步驟：從查看背面標示到回歸原型食物的行動指南](https://appi.news/images/appi-news-188/3.svg)
