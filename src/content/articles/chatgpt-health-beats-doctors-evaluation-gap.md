...
tags:
  ...
  - "AI治理"
  - "生成式AI"
coverImage: "covers/chatgpt-health-beats-doctors-evaluation-gap-cover.webp"
...
expertNote: "這件事對每天用 AI 問健康問題的一般人與提供健康服務的機構都重要。實務上，自評分數可以看，但不該直接當成採用依據，決策前該問「誰驗證、驗證方式跟真實使用情境差多遠」。最該留意的環節，是能不能在流程裡明確界定 AI 負責哪一段、由誰在哪一關把關，而不是模型分數本身。"
risksAndLimits:
