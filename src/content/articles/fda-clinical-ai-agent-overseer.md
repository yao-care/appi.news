...
tags:
  ...
  - "藥物研發"
  - "AI治理"
coverImage: "covers/fda-clinical-ai-agent-overseer-cover.webp"
...
expertNote: "對台灣醫療 AI 導入來說，這是「能力先於制度」的典型案例，重點不在技術做不做得出來，而在動手前有沒有把自主範圍、真人核准點、出錯歸責寫死。實務上該盯的不是這個 agent 準不準，是台灣自己的高風險應用有沒有先把這三格排好。"
risksAndLimits:
