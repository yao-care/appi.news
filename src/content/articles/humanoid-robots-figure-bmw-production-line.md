---
title: "人形機器人走進產線：Figure每小時造一台、BMW組裝3萬輛"
...
tags:
  ...
  - "製造業"
  - "AI"
coverImage: "covers/humanoid-robots-figure-bmw-production-line-cover.webp"
coverAlt: "機器人相關情境（示意圖）"
coverImageCredit: "Photo by Homa Appliances on Unsplash"
...
risksAndLimits:
  - "BMW 案例是單一車廠、單一鈑金取放任務的11個月部署，不代表通用組裝已成熟"
  - "單台成本約9萬至10萬美元、回收期18至24個月為現階段估算，實際導入成本因廠而異"
  - "文中前臂磨損與退役資訊僅來自單一部署案例，尚未有多廠、多場景的驗證數據"
  - "Apptronik、Tesla、Xpeng等同期量產計畫多為官方宣示目標，實際落地時程可能調整"
references:
...
這裡值得停一下。「每小時一台」這個速度本身不是重點，重點是 Figure 用工業化的產線方法在造人形機器人，不是在實驗室手工拼。首件良率、致動器產出、電池線良率，這些都是做量產才會去管的指標。Figure 把造機器人這件事，當成了一個製造問題在解，不是一個研究問題。一台機器人會不會做某個動作，跟一條產線能不能每小時穩定吐出一台合格品，難度完全不同。後者才是把炫技變成生意的那道坎。這股從實驗室走進產線的動能，也呼應近期資金[從聊天模型移向能驅動機器人的世界模型底層](/articles/odyssey-world-models-physical-ai-moat/)這個更大的趨勢。
