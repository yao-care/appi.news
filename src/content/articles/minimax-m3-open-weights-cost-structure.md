...
status: "scheduled"
coverImage: "covers/minimax-m3-open-weights-cost-structure-cover.webp"
...
把這個框架擺回 M3，你就會看懂為什麼「單價打到地板」不該讓你直接下單。一個單價便宜、但常常繞遠路的模型，跑你的真實任務時不一定比較省。便宜是 token 那一格的便宜，迷宮那一格便不便宜，要拿你自己的任務去跑才知道。反過來，貴的模型也只有在最難、最長的那種任務上才把多付的錢賺回來，這條規律我在[談 Mythos 級模型分層怎麼對應任務難度](/articles/claude-fable-5-mythos-class-model-tiering/)時拆過：短而規則明確的活，再強的模型也看不出差別。
