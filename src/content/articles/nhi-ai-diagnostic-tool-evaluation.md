...
expertNote: "健保這筆帳能不能算清楚，關鍵在衛福部這次是否真的把醫師時間與誤診成本量化進支付點數，而不是重演「年底評估」喊完沒下文的老路。臨床端該做的準備，不是等給付結果，是先想清楚判讀結果跟醫師意見不一致時誰說了算，這件事跟給付金額無關，卻決定工具核准後會不會真的被用。"
risksAndLimits:
  - "石崇良 2024 年 8 月喊的年底評估，指的是 2024 年底，官方公開資訊未見如期完成後續"
  - "CT 顱內出血判讀尚未公布對應的隨機對照試驗與確切給付結果，屬評估中而非定案"
  - "AI 影響性研究中心 2025 年 11 月才啟動，本土臨床試驗最快 3 年才可能有結果"
  - "支付點數 8,593 點僅適用麻醉血壓穩定監測案例，CT 顱內出血判讀給付金額尚未定案"
references:
...
<p>健保署從 2023 年起給付第一款 AI 醫材，用途是手術麻醉高風險病人的血壓穩定監測。下一步喊出要把 AI 影像判讀，例如電腦斷層顱內出血偵測，也送進健保給付名單，官方口徑是年底完成成本效益評估。這筆帳該怎麼算，決定了台灣 AI 醫療能不能從個案補助走向常規保障，而帳目裡最容易被忽略的一塊，不是模型準不準，是醫師省下多少時間、誤診一次要付出什麼代價、資源會不會被排擠掉。健保給付只是 AI 醫療落地的一半，另一半是個人健康資料被 AI 解讀時誰該負責，這件事我在<a href="/articles/chatgpt-health-nhi-sdk-accountability/">拆解健保健康存摺 SDK 與 ChatGPT Health 的責任歸屬設計</a>時談過。</p>
