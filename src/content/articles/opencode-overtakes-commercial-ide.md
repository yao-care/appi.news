...
<p>把這套搬到一個具體情境：一個三五個人的台灣小團隊，要從零挑一套 coding agent。常見的做法是先看誰排第一、誰功能多，挑了再說。這正是我一直在講的選型老毛病，順序倒過來了。我在<a href="/articles/what-is-claw-llm-client-tool/">先前談 LLM 工具選型那篇</a>說過同一件事：選工具的正確順序是先定義你的使用情境，再看哪類工具符合前提，最後才比較具體選項。</p>
