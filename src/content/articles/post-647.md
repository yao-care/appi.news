...
references:
  - title: "NASA and Blue Origin Launch Two Spacecraft to Study Mars Solar Wind"
    ...
    publisher: "NASA官方新聞室"
  - title: "NASA's ESCAPADE Mission Launches to Study Mars Atmosphere"
    url: "https://www.sciencedaily.com/releases/2026/03/260314030452.htm"
...
延伸閱讀：[NASA 公布 Artemis III 組員，義國太空人帕米塔諾成首位歐洲登月駕駛](/articles/artemis-iii-crew-parmitano/)
...
MMX的國際架構比ESCAPADE更為複雜。NASA提供質譜儀，法國CNES提供伽瑪射線光譜儀，德國DLR提供地形攝影機，ESA則參與任務設計與深空通訊支援。這個配置讓MMX成為一個多邊科學計畫，每個夥伴機構的參與都建立在具體的儀器貢獻上，而非僅是象徵性的合作備忘錄。對JAXA而言，[MMX是繼「隼鳥2號」小行星採樣成功後](https://www.mmx.jaxa.jp/en/mission/)的下一步，也是H3火箭執行大型行星探測任務的首次實戰機會。
...
### ESCAPADE任務要研究什麼？
研究太陽風如何長期剝蝕火星大氣，讓火星從稠密大氣、有液態水的環境變成現在的樣貌。任務用Blue與Gold兩顆衛星協調飛行，第一次能在三維空間追蹤太陽風與火星磁場互動的即時動態。

### ESCAPADE何時發射、何時抵達火星？
2026年3月14日由Blue Origin New Glenn火箭發射，展開18個月飛行，預計2027年9月進入火星軌道，之後運行至少一個地球年觀測太陽風對大氣的影響。

### JAXA的MMX任務要做什麼？
MMX前往火星衛星Phobos採集約10克表面樣本，用來釐清Phobos究竟是被捕獲的小行星，還是火星遭大撞擊後留下的碎片，預計2031年將樣本送回地球。

### ESCAPADE用兩顆衛星有什麼好處？
雙衛星可同步測量不同位置的磁場與粒子狀態，研究團隊能區分哪些是局部擾動、哪些是全球性系統變化，這是單顆衛星任務難以做到的。

### 這兩個任務對台灣衛星產業鏈有什麼意義？
Rocket Lab USA的模組化快速整合製造模式，以及JAXA在MMX中對多國供應商的整合方式，都提供台灣業者參照座標；要爭取分包機會，需建立符合深空任務可靠度標準的品質認證體系。
