---
title: "台灣數位健康法規到位：數位醫療產品納 AI 監管新標準"
slug: "taiwan-digital-health-ai-regulation"
...
expertNote: "台灣法規清楚只解決了「能不能做」，解決不了「能不能持續做」。對想進台灣的外資與本土業者來說，實務判斷該放在後市場監控和版本報備這塊灰色地帶，而不是暫時性藥證的申請門檻。這是接下來一到兩年最值得盯緊的變數，晚布局的業者屆時會措手不及。"
risksAndLimits:
...
### 台灣的《醫療器材管理法》如何界定數位醫療產品？
依《生技醫藥產業發展條例》第4條第1項第7款專條定義，涵蓋大資料分析、雲端運算、物聯網、AI與機器學習等應用於醫療照護的產品與服務，讓業者申請核准前就能確認產品是否落入法規範圍，降低申請前的不確定成本。

### AI與機器學習醫療器材目前依據哪些法規審查？
目前並無獨立專屬法規，而是依《醫療器材管理法》第四章臨床試驗相關規定審查，適用「醫療器材優良臨床試驗規範」、《人體研究法》與「人體試驗管理辦法」，食藥署已於2020年核准台灣第一套AI輔助診斷系統。

### 再生醫療雙法的暫時性藥證制度如何運作？
細胞治療新藥完成第二期臨床試驗後，即可向食藥署申請有效期5年的暫時性藥證，在特定條件下進入有條件商業化，不必等待通常需5至10年的完整三期試驗結束。

### 暫時性藥證制度對台灣生技業者有什麼實質幫助？
業者取得暫時性藥證後，能在第三期試驗進行期間開始回收部分商業收益，降低燒錢期的資金壓力，也讓吸引後期風險資本的條件改善，緩解中小型業者長期面臨的資金障礙。

### 台灣數位醫療法規目前最明顯的缺口是什麼？
AI與機器學習醫療器材仍缺乏獨立專屬監管規範，現行臨床試驗架構難以妥善處理AI模型持續學習與演算法版本更新的特性，食藥署尚未建立對應的版本更新報備與後市場監控框架。
