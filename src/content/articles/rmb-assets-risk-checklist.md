...
author: "wu-fang-jun"
coverImage: "covers/rmb-assets-risk-checklist.webp"
coverAlt: "臺灣家庭與中小企業主在桌前檢視人民幣存款、中國債券及多幣別現金流資料。"
status: published
sourceType: author
contentType: column
...
readingTime: 7
references:
  - title: "State Administration of Foreign Exchange. (2025). Foreign Exchange Receipts and Payments Data for the First Half of 2025: Press Conference Transcript"
    url: "https://www.safe.gov.cn/en/2025/0722/2328.html"
  - title: "Kwende G, Nephew E. (2025). Improving the Analytical Usefulness of the IMF’s COFER Data. *IMF Technical Notes and Manuals*, 2025/014"
    url: "https://www.imf.org/-/media/files/publications/tnm/2025/english/tnmea2025014.pdf"
  - title: "von Beschwitz B. (2024). Internationalization of the Chinese renminbi: progress and outlook. *FEDS Notes, Board of Governors of the Federal Reserve System"
  ...
  - title: "Perez-Saiz H, Zhang L. (2023). Renminbi Usage in Cross-Border Payments: Regional Patterns and the Role of Swap Lines and Offshore Clearing Banks. *IMF Working Papers*, 2023/077"
    url: "https://www.imf.org/-/media/files/publications/wp/2023/english/wpiea2023077-print-pdf.pdf"
  - title: "Swift. (2025). RMB Tracker, May 2025"
    url: "https://www.swift.com/sites/default/files/files/rmb-tracker_may-2025.pdf"
  - title: "Sharma R. (2026). The battle the US is winning against China. *Financial Times*, republished by CNA"
    url: "https://www.channelnewsasia.com/commentary/us-china-win-dollar-yuan-currency-trade-6130281"
draft: false
---
...
![三欄百分比圖比較人民幣占中國非銀行跨境收付百分之五十三、全球 SWIFT 支付百分之三點五零及全球官方外匯儲備百分之一點九八，並分別標示統計分母。](https://appi.news/images/rmb-assets-risk-checklist/2.png "人民幣在中國相關跨境收付的占比雖高，但全球支付與官方儲備占比仍低，三者分母不同，不能直接類比。")

## 二、人民幣國際化卡在哪些市場條件？

**儲備貨幣除了能支付，還要有充分可兌換性、資本進出管道、深度市場，以及壓力期間仍可交易的高品質資產。**

延伸閱讀：[中國1480億美元房產風險是什麼？3個常被搞混的重點](/articles/china-land-lease-risk-explained/)
...
![三張並列檢查卡分別列出人民幣存款、中國債券與兩岸貿易部位的用途及容易漏算的成本。](https://appi.news/images/rmb-assets-risk-checklist/3.svg "三類人民幣部位不能用同一套收益標準判斷，存款要重算換匯淨額，債券要合併多重風險，貿易部位則先查幣別錯配。")
...
1. 列出人民幣存款、中國債券、基金、應收款與應付款，包含間接曝險。
2. 記錄到期日、贖回限制、計價市場，以及最終要支付的幣別。
3. 家庭計算「人民幣資產／可投資資產」；企業計算未來 12 個月的人民幣流入與流出占比，逐月列出缺口。分母為零時，直接列缺口金額。
4. 套入三種壓力情境，檢查可承受損失與資金缺口。
5. 若集中度或缺口超出承受範圍，再評估分批調整期限或分散幣別。
