...
台灣醫療大數據等了十年，這一次真的有機會成局，而且不是靠政府掛勾。政府自己的全國電子病歷交換推了十年都沒解，證明有政府根本不是答案。這家公司有三個真的結構優勢，但這三項解得掉的是「供給端打不開、錢燒不起」，解不掉的是「信任」。更麻煩的是，讓它站起來的那個商業誘因，恰恰也是讓它可能倒下的門。
...
但最不中聽的一句在這裡：這三個優勢解掉的，是「供給端打不開」和「錢燒不起」這兩種死法，也就是新創、Watson、政府交換系統倒下的地方。它們一項都沒動到「信任」那種死法，也就是 care.data、23andMe、憲判 13 號倒下的地方。而且體量越大、又帶著科技巨頭和政府色彩，資料集中的疑慮反而更重。這裡的「集中」講的不是資料實體，資料實體是聯邦式、留在醫院；講的是控制權與受益權高度集中在少數幾家手上。Google 錢多到無限，Google Health 還是死在信任。
