---
title: 台灣醫療大數據，這局為什麼是現在才湊得起來？從十年戰史看台灣健康網路平台
slug: taiwan-health-data-why-now
description: 台灣不是沒試過整合健康資料，政府自己就推了十年，新創也一家家撞牆。台灣健康網路平台憑什麼不一樣？答案不是靠政府掛勾。它有三個真結構優勢，但解得掉錢與供給端的坑，解不掉信任的坑。
...
coverAlt: 多家規模不一的公司試圖打通醫院之間的資料高牆，象徵台灣醫療大數據整合的十年戰史
status: published
sourceType: author
...
highlights:
  ...
  - 國際上健康資料平台有四種不同的垮法：授權不透明、AI 撐不住臨床、公司倒了資料被賣、制度沒先備齊
  - 它的結構優勢解得掉錢與供給端的坑，解不掉信任的坑，而讓它站起來的商業誘因正是讓它可能倒下的門
readingTime: 11
...
台灣健康網路平台憑什麼避開過去失敗的坑，答案不是靠政府掛勾。政府自己的全國電子病歷交換推了十年都沒解，證明有政府根本不是答案。這家公司有三個真的結構優勢，但這三項解得掉的是「供給端打不開、錢燒不起」，解不掉的是「信任」。更麻煩的是，讓它站起來的那個商業誘因，恰恰也是讓它可能倒下的門。
...
要判斷這家公司會不會成，先看它前面躺了多少人。台灣整合健康資料這件事，不是沒試過，是試了很久。

政府自己下場最久。全國電子病歷交換系統推了十年，卡點很具體：[全台醫院各自擁有高達五十幾套不一樣的資訊系統，彼此無法互通，而且醫院把病歷分享給別家，在經濟上並沒有誘因](https://www.ithome.com.tw/news/133599)。技術後來靠 FHIR 這類標準逐步打通了，[電子病歷的推動也一路在做](https://dep.mohw.gov.tw/DOIM/cp-922-1247-114.html)，但那個「醫院為什麼要分享」的誘因問題，十年都沒真正解掉。這件事最該講給你聽：政府親自推了十年還卡著，所以「有政府撐腰」從來就不是答案。
...
有錢有局，就會成嗎？看國際的屍體會清醒一點。健康資料平台失敗的方式，不只一種。

第一種，死在信任。英國國民保健署的 care.data 想把全國家醫科病歷自動匯進單一資料庫，[結果病歷資料被提供給包含保險業者在內的商業公司、民眾又沒有被取得明確同意、退出機制也講不清楚，引爆全國性的信任危機，2013 年推、2016 年就廢止](https://medconfidential.org/whats-the-story/care-data-2013-2016/)。後來的接棒方案又踩同一個坑再喊停。

第二種，死在 AI 撐不住臨床。IBM 的 Watson for Oncology 跟知名的 MD Anderson 癌症中心合作，[燒掉 6,200 萬美元後喊停，因為無法跟醫院的病歷系統同步、資料不足、複雜病歷處理不了，整個 Watson Health 事業 2022 年以約 10 億美元賤賣給私募基金，遠低於投入](https://slate.com/technology/2022/01/ibm-watson-health-failure-artificial-intelligence.html)。
...
第三種，死在公司倒了資料被打包。基因檢測公司 23andMe 蒐集了超過 1,500 萬人的基因資料，[2023 年外洩、2025 年破產，基因資料在破產程序中變成可出售的資產，爭點正是沒有重新取得使用者主動同意就轉手，多州檢察長呼籲民眾趕快刪除自己的資料](https://www.npr.org/2025/03/24/nx-s1-5338622/23andme-bankruptcy-genetic-data-privacy)。這一種，直接命中很多人心裡那句「會不會哪天被賣掉」。

第四種，死在制度沒先備齊，而且就發生在台灣。健保資料庫的二次利用被告到憲法法庭，[2022 年憲判字第 13 號判健保法部分違憲，理由是缺獨立監督機制、對個資的處理儲存外傳沒有明文、也沒有退出機制，限三年內修法](https://udn.com/news/story/10025/6532707)。這件事的資料，你我也在裡面。

## 這家憑什麼不一樣，而且不是靠掛勾

看懂這四種死法，才看得懂這家公司真正的優勢在哪。它有三個結構優勢，跟政治關係無關。
...
## 最尖的一刀：讓它站起來的誘因，也是讓它倒下的門

但這裡要說一句最不中聽的。這三個優勢解掉的，是「供給端打不開」和「錢燒不起」這兩種死法，也就是新創、Watson、政府交換系統倒下的地方。它們一項都沒動到「信任」那種死法，也就是 care.data、23andMe、憲判 13 號倒下的地方。而且體量越大、又帶著科技巨頭和政府色彩，資料集中的疑慮反而更重。這裡的「集中」講的不是資料實體，資料實體是聯邦式、留在醫院；講的是控制權與受益權高度集中在少數幾家手上。Google 錢多到無限，Google Health 還是死在信任。

更尖的一點是：讓它避開「醫院不肯分享」的那個商業誘因，恰恰就是讓它暴露在「資料被當成資產、二次利用被放寬」的同一個誘因。解掉一種死法的東西，正好是打開另一種死法的門，23andMe 就是這樣倒的。
...
所以答案不是「掛勾所以會成」，也不是「公司大所以會成」。政府自己十年證明掛勾不夠，Google 證明有錢不夠。真正的分水嶺是信任怎麼設計：主動同意、清楚退出、獨立監理、二次利用有界。這剛好也是[你我這些資料供給者手上真正的籌碼](/articles/taiwan-health-data-platform-join/)。至於信任要怎麼一步一步做進系統，我把自己做醫療 AI 合規工具踩過的坑，寫在[另一篇](/articles/medical-ai-compliance-lessons/)。
